...
import { SiJavascript,SiSpring,SiMysql} from "react-icons/si"
  ...
  return (
    <div className="pb-24">
        ...
        className="flex flex-wrap items-center justify-center gap-4">
            ...
            className="p-4">
                <FaCss3Alt className="text-7xl text-purple-600"></FaCss3Alt>
            </motion.div>
            <motion.div
             initial="initial"
             animate="animate"
            ...
            className="p-4">
                <FaJava className="text-7xl text-blue-800"></FaJava>
            </motion.div>
            <motion.div
             initial="initial"
             animate="animate"
             variants={iconVariants(2.5)}
            className="p-4">
                <SiSpring className="text-7xl text-green-600"></SiSpring>
            </motion.div>
            <motion.div
             initial="initial"
             animate="animate"
             variants={iconVariants(5)}
            className="p-4">
                <SiMysql className="text-7xl text-blue-900"></SiMysql>
            </motion.div>
            <motion.div
             initial="initial"
             animate="animate"
